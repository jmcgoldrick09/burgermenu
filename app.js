...
const connection = mysql.createConnection( 
   { 
      ...
      database: 'lab07', // this is the NAME of your DB 
...
app.post('/admin/add', (req, res) => {
    ...
    const InsertBurgersSQL =`INSERT into web_dev_burgers (b_name, description, ingredients, price, img) VALUES (${burgerN}, ${descriptB}, ${ingredsB}, ${priceB},"default.jpg");`;
